...
#reader(lib "htdp-intermediate-reader.ss" "lang")((modname insert-in-bst) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
...
;; produce a new BST by entering the given key value pair into the proper place in the BST
